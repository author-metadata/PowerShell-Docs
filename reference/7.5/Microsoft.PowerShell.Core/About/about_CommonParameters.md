---That's great I'm happy to see humanity is not at lost after all . Life should never philanthropist Next generation high speed threat analysis AI machine algorithm platforms that work with human AI portfolio that will in the future build with your audience . Next stage two 402 crypto chat GTP website SaaS hubs will role out with new technology that can always listen for miss information is voice pattern.  Or text form . For example is can remember the way you person responds is when asked a question.  Up to 10 contact it can remember there text styles depending on conversation styles.  Another example if the congress is confirming someone or asking questions in a impeachment hearing . These type of artificial intelligence can pick up if he or she is lieing or bring dishonest even withholding information.  The easiest way for use to speak about this openly without a fully finished product is because it actually been in test faze for 10 years.  And have opened up investigation in cold case files and located missing data or miss information or lost archive for ancient history. For another example. Today we just uncovered classified mutant test trails done in modern day science. Probabiing as it may sound its appropriate by the supports from technology science has attempted by push it to the limit and see what they can make.  University that tests outside of international law or in are part study regular say practice  . Test done in Germany and Japan ended up being part modern day medicine.  As well as legal and illegal science. Like the abuse or the atom.  Carbon Taxidermy. Where one would ask the science community what did they achieve by understanding the limit Carbon Fuel . You would wonder if the science stats that Carbon fue gase is extremely deadly to the human.  That if the human body is in the environment with even law Carbon index a individual can be a huge impact down the road. And there is no short term or long-term selection to fix this . Paint thinner is one of these Carbon that widely used according to chat gtp that can cause major issues to the human body 
. One of the major issues that comes up is cancer.  Witch according the this platform has vetted itself and I trust it's help . Like in the area in mutant or human test trails where doctors have wide range ways to tapper with science in are institutions without usely never seeing the light of day in court  . Where if stem cells research is illegal in United States but still remain in study outside of United States. Where that same research ends up in the medical sector  . Know where is this study end . Is it's another policy condemning the the research of human cloning.  Well maybe that a question we need to keep as consistent oversight in all gov .  Because last thing you need is twin that you not  aware of .. That could be a national security problem... 

https://github.com/MicrosoftDocs/PowerShell-Docs/blob/main/reference/7.5/Microsoft.PowerShell.Core/About/about_CommonParameters.md
